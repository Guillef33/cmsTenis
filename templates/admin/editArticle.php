...
<?php } ?>
        ...
        <ul>
          ...
          <li>
            ...
            <input type="text" name="category" id="category" placeholder="Name of the category" required autofocus maxlength="255" value="<?php echo htmlspecialchars( $results['article']->category )?>" />
          </li>
          ...
          <li>
            ...
            <input type="file" name="image" id="image" value="<?php echo htmlspecialchars( $results['article']->image )?>" />
          </li>
